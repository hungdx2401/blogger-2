...
<div class="container">
	<div class="block-header">
		<h2>
			Danh sách danh mục &nbsp;
			<button class="btn btn-default btn-icon" data-ui-sref="category.create" data-ng-click="mactrl.sidebarStat($event)">
				<i class="md md-add"></i>
			</button>
		</h2>
	</div>

	<div class="card" ng-show="list.length>0">
		<br>
		<table class="table table-striped table-vmiddle">
			...
			<tbody>
				<tr ng-repeat="obj in list">
					...
					<td><a href="#/category/edit?id={{obj.id}}"><button class="btn btn-icon command-edit" type="button">
		...
		<div id="undefined-footer" class="bootgrid-footer container-fluid">
			<div class="row">
				<div class="col-sm-6">
					<ul class="pagination" ng-show="list.length>0">
				...
				<div class="col-sm-6 infoBar">
					<div class="infos">Hiển thị từ {{((page-1)*limit + 1)}} đến {{(page-1)*limit + list.length}}/{{totalItem}}</div>
				</div>
			</div>
		</div>
	</div>
